...
finalWave = np.sin(500 * 2 * np.pi * t) + np.sin(1000 * 2 * np.pi * t) + np.sin(1500 * 2 * np.pi * t) + np.sin(2000 * 2 * np.pi * t) + np.sin(2500 * 2 * np.pi * t) + np.sin(3000 * 2 * np.pi * t) + np.sin(3500 * 2 * np.pi * t) + np.sin(4000 * 2 * np.pi * t) + np.sin(4500 * 2 * np.pi * t) + np.sin(500 * 2 * np.pi * t)
